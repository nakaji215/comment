(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const m of r)if(m.type==="childList")for(const a of m.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const m={};return r.integrity&&(m.integrity=r.integrity),r.referrerPolicy&&(m.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?m.credentials="include":r.crossOrigin==="anonymous"?m.credentials="omit":m.credentials="same-origin",m}function o(r){if(r.ep)return;r.ep=!0;const m=t(r);fetch(r.href,m)}})();window.updateDisplayAndColors=d;window.updateColorFromPicker=ee;window.updateColorFromText=te;window.updateAllColors=re;function d(){var p,h,u,b,g,F,y,v,x,f,E,C,B,w,k,$,I,L,A,S,D,q,O,T,P,z,M,N,V,j,H,Y,U,J,K,G,R,Z,Q;let e=(p=document.querySelector('input[name="author-name-display"]:checked'))==null?void 0:p.value,n=(h=document.querySelector('input[name="border-block"]:checked'))==null?void 0:h.value,t=(u=document.querySelector('input[name="icon-display"]:checked'))==null?void 0:u.value;document.querySelectorAll(".comment-channel").forEach(s=>{s.style.display=e}),document.querySelectorAll(".comment-icon").forEach(s=>{s.style.display=t});let m=document.querySelectorAll(".comment-message"),a="",i="3px solid var(--listener-comment-border)",c="3px solid var(--member-comment-border)";m.forEach(s=>{if(n==="0")s.style.border="none",a="none",i="none",c="none";else{a='""';let W=s.parentElement.parentElement.getAttribute("author-type");W===""?s.style.border=i:W==="member"&&(s.style.border=c)}}),document.querySelectorAll(".comment-before").forEach(s=>{s.style.display=n==="0"?"none":"block"});let X=`
    :root {
